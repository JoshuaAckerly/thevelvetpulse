#!/bin/bash
# Test Server Deployment Script for The Velvet Pulse
...
if command -v supervisorctl &> /dev/null; then
    ...
    sudo supervisorctl restart thevelvetpulse-worker:* 2>/dev/null || echo "No queue workers configured yet"
fi
...
echo "=================================="
echo "🌐 Your site should now be live at test-thevelvetpulse.yourdomain.com"
